...
TEST_CASE("egraph add constants", "[egraph]") {
    ...
    SECTION("add multiple constants") {
        eqx_eclass_id_t id1 = eqx_egraph_add(egraph, 1, NULL, 0);
        eqx_eclass_id_t id2 = eqx_egraph_add(egraph, 2, NULL, 0);
        eqx_eclass_id_t id3 = eqx_egraph_add(egraph, 3, NULL, 0);
    ...
    SECTION("same constant added twice returns same e-class") {
        eqx_eclass_id_t id1 = eqx_egraph_add(egraph, 42, NULL, 0);
        eqx_eclass_id_t id2 = eqx_egraph_add(egraph, 42, NULL, 0);
        REQUIRE(id1 == id2);
    }
...
TEST_CASE("egraph add applications", "[egraph]") {
    ...
    SECTION("same application returns same e-class") {
        ...
        eqx_eclass_id_t children[] = {c1, c2};
        eqx_eclass_id_t app1 = eqx_egraph_add(egraph, 100, children, 2);
        eqx_eclass_id_t app2 = eqx_egraph_add(egraph, 100, children, 2);
...
TEST_CASE("egraph congruence closure", "[egraph]") {
    ...
    SECTION("congruence propagates through applications") {
        ...
        eqx_eclass_id_t c = eqx_egraph_add(egraph, 3, NULL, 0);
        eqx_eclass_id_t d = eqx_egraph_add(egraph, 4, NULL, 0);
        
        eqx_eclass_id_t children1[] = {a, b};
        eqx_eclass_id_t f_ab = eqx_egraph_add(egraph, 100, children1, 2);
        
        eqx_eclass_id_t children2[] = {c, d};
        eqx_eclass_id_t f_cd = eqx_egraph_add(egraph, 100, children2, 2);
...
TEST_CASE("egraph statistics", "[egraph]") {
    ...
    SECTION("statistics after adding nodes") {
        eqx_egraph_add(egraph, 1, NULL, 0);
        eqx_egraph_add(egraph, 2, NULL, 0);
...
TEST_CASE("egraph iterator", "[egraph]") {
    ...
    eqx_egraph_add(egraph, 1, NULL, 0);
    eqx_egraph_add(egraph, 2, NULL, 0);
    eqx_egraph_add(egraph, 3, NULL, 0);
